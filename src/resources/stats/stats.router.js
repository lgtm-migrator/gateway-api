...
router.get('/', async (req, res) => { 
  ...
  router.get('/kpis', async (req, res) => { 
    ...
    switch (req.query.kpi) {
      ...
      case 'searchanddar':
        console.log('date: ' + req.query.selectedDate )
        console.log('date type: ' + typeof req.query.selectedDate )
  ...
  //TODO COMMENT OUT AFTER SWITCHING TO ONE ABOVE
...
//TODO COMMENT OUT AFTER SWITCHING TO SEARCHANDDAR 
