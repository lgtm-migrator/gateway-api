...
describe('injectQuestionActions', () => {
    ...
    const cases =  [[data[0].jsonSchema, constants.userTypes.APPLICANT, constants.applicationStatuses.INPROGRESS, '', [guidance]], 
                    ...
                    [data[0].jsonSchema, constants.userTypes.CUSTODIAN, constants.applicationStatuses.APPROVEDWITHCONDITIONS, constants.roleTypes.MANAGER, [guidance]],
                    [data[0].jsonSchema, constants.userTypes.CUSTODIAN, constants.applicationStatuses.INREVIEW, constants.roleTypes.MANAGER, [guidance, requestAmendment]],
                    ...
                    [data[0].jsonSchema, constants.userTypes.CUSTODIAN, constants.applicationStatuses.SUBMITTED, constants.roleTypes.MANAGER, [guidance, requestAmendment]],
                    ...
                    [data[0].jsonSchema, constants.userTypes.CUSTODIAN, constants.applicationStatuses.APPROVEDWITHCONDITIONS, constants.roleTypes.REVIEWER, [guidance]],
