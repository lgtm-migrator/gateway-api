		...
		try {
			...
			if (messageType === 'message') {
				...
				emailGenerator.sendEmail(
					...
					messageRecipients,
					`You have received a new message on the ${i18next.t('translation:environment')} Gateway`,
					`You have received a new message on the ${i18next.t(
						'translation:environment'
					)} Gateway. <br> Log in to view your messages here : <a href='${process.env.homeURL}'> ICODA Gateway'</a>`,
					false
				);
			}
